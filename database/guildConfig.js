...
function defaultConfig() {
  return {
    ...
    // === إضافات جديدة ===
    // رتبة تُعفى فقط من حماية إعطاء/سحب الرتب من الأعضاء (أمر /حماية_رتب_الاعضاء)
    exemptRoleId: null,
    // الروم الصوتي الذي يبقى البوت متصلاً فيه بشكل ثابت (أمر /دخول_صوتي و /خروج_صوتي)
    stickyVoiceChannelId: null,
  };
}
